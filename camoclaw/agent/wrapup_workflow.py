...
class WrapUpWorkflow:
    ...
    def _list_artifacts_node(self, state: WrapUpState) -> WrapUpState:
        ...
        try:
            ...
            # Scan multiple directories where artifacts might be (include camoclaw_work used by execute_code)
            directories_to_scan = ["/tmp", "/home/user", "/home/user/artifacts", "/home/user/camoclaw_work"]
...
Response (JSON array only):"""
    ...
    def _submit_work_node(self, state: WrapUpState) -> WrapUpState:
        ...
        try:
            ...
            from camoclaw.tools.direct_tools import submit_work
