"""
MCP Tools - Economic status, task details, and work submission
"""
...
CURRENT_STATE = {
    ...
    "current_date": None,
    "current_task": None,
    "data_path": "./camoclaw/data/agent_data"
}
...
def set_global_state(
    ...
    data_path: str = "./camoclaw/data/agent_data"
):
...
def learn_from_web(query: str, max_results: int = 3, save_to_memory_flag: bool = True, memory_topic: str = "") -> dict:
    ...
    Uses the search_web implementation from camoclaw.tools.productivity.search,
    ...
    try:
        from camoclaw.tools.productivity.search import search_web as _search_web_impl
    except ImportError:
        return {"error": "search_web implementation not found in camoclaw.tools.productivity.search"}
