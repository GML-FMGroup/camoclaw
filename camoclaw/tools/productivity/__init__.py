...
try:
    ...
    import warnings
    warnings.warn(f"camoclaw.tools.productivity: search not loaded: {e}")
...
try:
    ...
    import warnings
    warnings.warn(f"camoclaw.tools.productivity: create_file not loaded: {e}")

try:
    from .code_execution_sandbox import execute_code as execute_code_sandbox
except ImportError as e:
    import warnings
    warnings.warn(f"camoclaw.tools.productivity: execute_code_sandbox not loaded (install e2b-code-interpreter): {e}")
...
try:
    ...
    import warnings
    warnings.warn(f"camoclaw.tools.productivity: read_file not loaded: {e}")
...
try:
    ...
    import warnings
    warnings.warn(f"camoclaw.tools.productivity: create_video not loaded: {e}")
