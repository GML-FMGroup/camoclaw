...
Productivity tools: Imported from camoclaw.tools.productivity
"""
...
from camoclaw.utils.logger import get_logger
...
# Concatenated path: host sandbox path + E2B segment (e.g. .../sandbox/2025-01-15/home/user/camoclaw_work/file.xlsx)
_CONCAT_PATH_MARKERS = ("/home/user/", "\\home\\user\\", "/camoclaw_work/", "\\camoclaw_work\\")
        ...
        if concat_paths:
            return {
                "error": (
                    ...
                    "Paths containing 'home/user' or 'camoclaw_work' in the middle are invalid."
                ),
...
try:
    from camoclaw.tools.productivity import (
    ...
    if not PRODUCTIVITY_TOOLS_AVAILABLE:
        print("⚠️ Productivity tools not available (camoclaw.tools.productivity not loaded)")
...
def get_all_tools(
    ...
    *,
    ...
    if skill_enabled:
        try:
            from camoclaw.skill import get_skill_tools
